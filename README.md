...
- A custom **`div`** follows the mouse movement smoothly

### Design Technique
- **`mix-blend-mode: difference`** dynamically inverts colors depending on the background element beneath the cursor
